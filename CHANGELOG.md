...
A patch release about output you can act on. Three failure messages were true
and useless, in the way that costs the most time: they pointed at the wrong step,
or offered a knob that could not help. Nothing in the spec language changes, and
one key is added.
