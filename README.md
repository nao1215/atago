...
| [htop](https://htop.dev/) | Full-screen alternate-screen TUI as a pty screen-rendering testbed: the rendered frame shows the meters and column header, `q` quits with a clean lifecycle, and an unknown flag is rejected before the TUI opens. | GPL-2.0 | [specs](test/e2e/thirdparty/htop) | [docs](doc/e2e/htop.md) |
